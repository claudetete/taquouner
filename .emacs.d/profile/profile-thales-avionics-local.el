...
(try-require 'profile-thales-avionics-local-private "    ")
...
(when tqnr-section-misc
  ...
  (setq tqnr-profile-browser "firefox.exe")
  ;;
...
(provide 'profile-thales-avionics-local)

;;; profile-thales-avionics-local.el ends here
