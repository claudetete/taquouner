...
(when tqnr-section-function
  ...
  (setq tqnr-section-function-magneti-marelli t)

  ;; ECB: custom function about ecb mode
  (setq tqnr-section-function-ecb t)
...
(when tqnr-section-mode
  ...
  (setq tqnr-section-mode-mm-eol t)

  ;; MM DBC: CAN dbc mode
  (setq tqnr-section-mode-mm-dbc t)

  ;; MM DIFF: synergy classic diff mode
  (setq tqnr-section-mode-mm-diff t)
  ...
  (setq tqnr-section-mode-csv nil)
  ...
  (setq tqnr-section-mode-powerline nil)
  ...
  (setq tqnr-section-mode-dired-details nil)
...
(when tqnr-section-languages
  ...
  (when tqnr-section-languages-c
    ...
    (setq tqnr-section-languages-c-indent-preprocessor t)
    ...
    (setq tqnr-profile-c-macro-cppflags "-D__ALONE_MICRO__ -D__CLIENT_EOL_LINK__ -D__EOL_ENABLE__ -D__RTOS__")
    ) ;; (when tqnr-section-languages-c
  ;;
  ;; LISP
...
(when tqnr-section-interface
  ...
  (when tqnr-section-interface-main-window
    ...
    (setq tqnr-profile-transparency 90)
    ;;
...
(when tqnr-section-misc
  ...
  (setq tqnr-profile-fill-column 78)
  ;;
