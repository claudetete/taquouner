...
(when tqnr-section-function
  ...
  (setq tqnr-section-function-auctex t)
  ...
  (setq tqnr-section-function-clearcase t)

  ;; RTRT: custom function about RTRT script .ptu file
  (setq tqnr-section-function-rtrt t)
  ) ;; (when tqnr-section-function
...
(when tqnr-section-mode
  ...
  (when tqnr-section-mode-cedet
    ...
    (setq tqnr-profile-cedet-path (concat (file-name-as-directory tqnr-dotemacs-path) "plugins/cedet-1.1/common/cedet.elc"))
    ...
    (setq tqnr-section-mode-cedet-ecb t)
  ...
  (setq tqnr-section-mode-rtrt-script t)
  ...
  (setq tqnr-section-mode-clearcase t)
  ...
  (when tqnr-section-mode-org-mode
    ...
    (setq tqnr-profile-org-directory "")
    ;; default org file where all task/todo capture will goes
    (setq tqnr-profile-org-default-notes-file (concat (file-name-as-directory tqnr-profile-org-directory) ""))
    ;; agenda will look only in default org file
    (setq tqnr-profile-org-agenda-files (concat (file-name-as-directory tqnr-profile-org-directory) ""))
    ;; first buffer to show up is default org file when opening emacs
    (setq tqnr-section-mode-org-default-as-init-buffer nil)
    ) ;; (when tqnr-section-mode-org-mode
  ...
  ;; AUCTEX: latex mode
  (setq tqnr-section-mode-auctex t)
...
(when tqnr-section-languages
  ...
  (when tqnr-section-languages-c
    ...
    (setq tqnr-profile-c-indent-offset 3)
  ...
  ;; RTRT SCRIPT PTU
  ;;   set indentation style
  (setq tqnr-section-languages-rtrt-script t)
...
(when tqnr-section-display
  ...
  (when tqnr-section-display-font
    ...
    ;; "Droid Sans Mono-10"
    ;; "Droid Sans Mono-8"
    (setq tqnr-profile-font "ProggyTinySZ-6")
  ...
  (when tqnr-section-display-color
    ...
    (setq tqnr-profile-color-theme "sweet")
...
(when tqnr-section-annoyances
  ...
  (when tqnr-section-annoyances-backup-file-in-directory
    ...
    (setq tqnr-profile-backup-directory nil)
    (setq tqnr-profile-autosave-directory nil)
    ) ;; (when tqnr-section-annoyances-backup-file-in-directory
  ) ;; (when tqnr-section-annoyances
