;;; profile-thales-local.el --- a config file for profile
...
(try-require 'profile-thales-local-private "    ")
  ...
  (when tqnr-section-environment-set-path
    ...
    (setq tqnr-profile-path
      (list
        ...
        ;; GNU Emacs
        "D:/Users/S0070736/tools/GNU_Emacs/emacs-25.3_1-x86_64/bin"
        ;; MSYS2
        "D:/Users/S0070736/tools/msys64/usr/bin"
        "D:/Users/S0070736/tools/msys64/mingw64/bin"
...
(when tqnr-section-mode
  ...
  (when tqnr-section-mode-org-mode
    ...
    (setq tqnr-profile-org-directory "D:/Users/S0070736/tools/GNU_Emacs/org")
...
(provide 'profile-thales-local)

;;; profile-thales-local.el ends here
