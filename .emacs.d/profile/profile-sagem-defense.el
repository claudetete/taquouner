...
;           "y:/BANDAS_sw/BANDAS.ede.el"
           ;; TAMBORIM
           "z:/Source/TAMBORIM_sw~FT346598/TAMBORIM_sw/TAMBORIM.ede.el"
           )
        )
      ) ; (when section-mode-cedet-semantic
    ...
    (when section-mode-cedet-ecb
      ...
      (setq profile-ecb-source-path
        '(
           ...
           ("Z:/Source/KC390_sw~FT346598/KC390_sw"                "KC390_sw")
           ("Z:/Source/GEN_databases~FT346598/GEN_databases"      "GEN_databases")
           ("Z:/Source/Scripts_trace32~FT346598/Scripts_trace32"  "Scripts_trace32")
           ("Z:/"                                                 "KC390_synergy")
