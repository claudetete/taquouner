;;; profile-akka.el --- a config file for profile
...
(try-require 'profile-akka-private "    ")
  ...
  (when tqnr-section-environment-set-path
    ...
    (setq tqnr-profile-path
      (list
        ...
        "c:/GNAT/2017/bin"
        "C:/Users/claude.tete/LiberKey/MyApps/WinPython-64bit-3.6.2.0Qt5/python-3.6.2.amd64"
        ;; emacs useful binary
        ...
        ;; GNU Emacs
        "C:/Users/claude.tete/LiberKey/MyApps/GNU_EmacsPortable/App/GNU_Emacs/emacs-25.3_1-x86_64/bin"
        ;; MSYS2
        "D:/CTE/msys64/usr/bin"
        "D:/CTE/msys64/mingw64/bin"
        ;; Python utils
        "C:/Users/claude.tete/LiberKey/MyApps/WinPython-64bit-3.6.2.0Qt5/python-3.6.2.amd64/Scripts"
        "C:/Users/claude.tete/LiberKey/MyApps/WinPython-64bit-3.6.2.0Qt5"
...
(when tqnr-section-mode
  ...
  (when tqnr-section-mode-org-mode
    ...
    (setq tqnr-profile-org-default-notes-file (concat (file-name-as-directory tqnr-profile-org-directory) "AKKA.org"))
...
(provide 'profile-akka)

;;; profile-akka.el ends here
