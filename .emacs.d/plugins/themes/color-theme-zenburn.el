...
(defun color-theme-zenburn ()
  ...
  (color-theme-install
    `(color-theme-zenburn
       ...
       (shadow ((t (:foreground ,zenburn-yellow))))
       (link ((t (:foreground ,zenburn-red))))
       ...
       (which-func ((t (:foreground ,zenburn-blue))))
       ...
       (ecb-source-read-only-face ((t (:background ,zenburn-bg-1))))

       ;; hide-ifdef
       (hide-ifdef-shadow ((t (:background ,zenburn-bg-1 :foreground ,zenburn-fg :box nil))))
