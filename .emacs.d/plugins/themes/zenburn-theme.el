...
;;;;; basic coloring
   ...
   `(warning ((t (:foreground ,zenburn-red-6 :weight bold))))
...
;;;;; font lock
   ...
   `(font-lock-constant-face ((t (:foreground ,zenburn-green+4 :background ,zenburn-bg))))
   `(font-lock-doc-face ((t (:foreground ,zenburn-green+2 :background ,zenburn-bg))))
   ...
   `(font-lock-string-face ((t (:foreground ,zenburn-red :background ,zenburn-bg))))
