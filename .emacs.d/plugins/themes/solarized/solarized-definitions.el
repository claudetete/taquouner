      ...
      (let ((back base03))
        ...
        (let ((bg-back   `(:background ,back))
          ...
          `((;; basic
             ...
             (header-line ((t (,@fg-base0 ,@bg-base02)))) ; Pmenu
	     ...
	     (bm-fringe-persistent-face ((t (,@bg-blue ,@fg-base03))))
             ;; ecb
             (ecb-default-highlight-face ((t (,@fg-base01 ,@bg-base03 ,@fmt-revbb))))
	     (ecb-source-read-only-face ((t (,@fg-base1 ,@bg-base02))))
             ;; Flymake
	     ...
	     (git-gutter:deleted ((t (,@fg-red))))
             ...
             ;; yascroll
             (yascroll:thumb-fringe ((t (,@fg-base0))))
             ;; rcirc
