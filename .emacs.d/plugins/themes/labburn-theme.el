...
;;;;; basic coloring
 ...
 `(fringe ((t (:foreground ,labburn-bg :background ,labburn-bg-1))))
...
;;;;; isearch
 ...
 `(mode-line
   ((,labburn-class (:foreground ,labburn-bg-1 :background ,labburn-green+1 :box nil))
    (t :inverse-video t)))
 `(mode-line-buffer-id ((t (:foreground ,labburn-yellow))))
 `(mode-line-inactive
   ((t (:foreground ,labburn-green-1 :background ,labburn-bg-2 :box nil))))
...
;;;;; powerline
 `(powerline-active1 ((t (:background ,labburn-bg-05 :foreground ,labburn-fg :inherit mode-line))))
 `(powerline-active2 ((t (:background ,labburn-bg+2 :foreground ,labburn-fg :inherit mode-line))))
 `(powerline-inactive1 ((t (:background ,labburn-bg+1 :foreground ,labburn-fg :inherit mode-line-inactive))))
 `(powerline-inactive2 ((t (:background ,labburn-bg+3 :foreground ,labburn-fg :inherit mode-line-inactive))))
;;;;; rainbow-delimiters
