...
(defcustom dumb-jump-find-rules
  '((:type "function" :supports ("ag" "grep" "rg" "git-grep") :language "elisp"
    ...
    ;; ada
    (:type "function" :supports ("ag" "grep" "rg" "git-grep") :language "ada"
      :regex "function\\s*JJJ\\s*"
      :tests ("function Test_Test (" " function test"))

    (:type "function" :supports ("ag" "grep" "rg" "git-grep") :language "ada"
      :regex "procedure\\s*+JJJ\\s*"
      :tests ("procedure Test_Test (" " procedure test("))

    (:type "variable" :supports ("ag" "grep" "rg" "git-grep") :language "ada"
      :regex "JJJ\\s*:[^=]"
      :tests ("Test : Type;" " Test : Type := 0.0;" "Test : in out Type)")
      :not ("Test := 0.0"))

    (:type "type" :supports ("ag" "grep" "rg" "git-grep") :language "ada"
           :regex "type\\s+JJJ\\s*"
           :tests ("type Test is" "type T_Test (Test) is"))
...
(defcustom dumb-jump-language-file-exts
  '((:language "elisp" :ext "el" :agtype "elisp" :rgtype "elisp")
    ...
    (:language "ada" :ext "adb" :agtype "ada" :rgtype "ada")
    (:language "ada" :ext "ads" :agtype "ada" :rgtype "ada")
...
(defun dumb-jump-concat-command (&rest parts)
  ...
  ;;(message (s-join " " (-map #'s-trim (--filter (> (length it) 0) parts))))
